...
class OSDiff(LatentDiffusion):
    ...
    def apply_condition_compress(self, control, stream_path, H, W):
        ...
        out = self.preprocess_model.compress(ref, None) 
        shape = out["shape"]
    ...
    def configure_optimizers(self): 
        ...
        if not self.sd_locked: 
            params_d = list(self.model.diffusion_model.parameters()) 
    ...
    def p_losses(self, image,x_start, cond, t, generator_turn=False, guidance_turn=False, noise=None): 
        loss_dict = {}
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss, loss_dict = self.shared_step(batch,generator_turn=True, guidance_turn=False) 
